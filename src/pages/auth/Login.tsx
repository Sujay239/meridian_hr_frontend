        ...
        <div className="hidden lg:relative lg:flex lg:flex-col lg:items-start lg:justify-end lg:p-20 overflow-hidden bg-slate-900">
          ...
          <div className="relative z-10 space-y-6 max-w-lg animate-in slide-in-from-left-10 duration-700">
            ...
            <h1 className="text-5xl font-bold tracking-tight text-white leading-tight">
              Manage your{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#fac5c8] to-[#9a91ff]">
                Workspace
              </span>{" "}
              with confidence.
            </h1>
            <p className="text-lg text-slate-300 font-light leading-relaxed">
              Streamline attendance, payroll, task management, and team
          ...
          <div className="w-full flex flex-col justify-center max-w-md space-y-8 animate-in fade-in zoom-in-95 duration-500 lg:mt-36">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                {loading ? (
                  <>
                    <svg
                      className="animate-spin -ml-1 mr-2 h-4 w-4 text-white dark:text-slate-900"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                    >
            ...
            <p className="text-center text-sm text-slate-500 dark:text-slate-400">
              ...
              <button
                ...
                className="font-semibold text-slate-900 dark:text-white opacity-70 cursor-pointer"
              >
